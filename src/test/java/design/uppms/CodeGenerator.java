...
public class CodeGenerator {
    public static void main(String[] args) {
        ...
        dataSourceConfig
                ...
                .setUrl("jdbc:mysql://localhost:3306/uppms?useSSL=false&characterEncoding=utf8&serverTimezone=Asia/Shanghai");
        mpg.setDataSource(dataSourceConfig);

        //包名设置
        PackageConfig packageConfig = new PackageConfig();
        packageConfig
                .setParent("design.uppms")      //父包名。如果为空，将下面子包名必须写全部， 否则就只需写子包名
    ...
    private static Map<String, String> getPathInfo() {
        ...
        pathInfo.put(ConstVal.ENTITY_PATH, System.getProperty("user.dir") + "/src/main/java/design/uppms/model/po");        //System.getProperty("user.dir")用户当前工作目录
        pathInfo.put(ConstVal.MAPPER_PATH, System.getProperty("user.dir") + "/src/main/java/design/uppms/mapper");
        pathInfo.put(ConstVal.SERVICE_PATH, System.getProperty("user.dir") + "/src/main/java/design/uppms/service");
        pathInfo.put(ConstVal.SERVICE_IMPL_PATH, System.getProperty("user.dir") + "/src/main/java/design/uppms/service/impl");
